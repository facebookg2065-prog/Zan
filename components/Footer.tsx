        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              <a href="#" aria-label="فيسبوك باوره بلس" className="w-12 h-12 bg-stone-800 rounded-2xl flex items-center justify-center hover:bg-brand-primary transition-all shadow-lg">
                <i className="fab fa-facebook-f" aria-hidden="true"></i>
              </a>
              <a href="#" aria-label="انستجرام باوره بلس" className="w-12 h-12 bg-stone-800 rounded-2xl flex items-center justify-center hover:bg-pink-600 transition-all shadow-lg">
                <i className="fab fa-instagram" aria-hidden="true"></i>
              </a>
              <a href="https://t.me/PARONPRO" target="_blank" rel="noopener noreferrer" aria-label="تليجرام باوره بلس" className="w-12 h-12 bg-stone-800 rounded-2xl flex items-center justify-center hover:bg-sky-500 transition-all shadow-lg">
          ...
          <div>
            ...
            <ul className="space-y-5 text-stone-300">
              ...
              <li className="flex items-center gap-4 group">
                ...
                <a href="https://wa.me/967778301265" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors font-bold">+967 778 301 265</a>
              </li>
            </ul>
          </div>
