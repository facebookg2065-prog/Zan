    ...
    <section id="products" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl font-black text-brand-secondary mt-3 mb-6">خلاصة الأرض اليمنية</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {products.map((p, idx) => (
            <div key={idx} className="bg-brand-earth/30 rounded-[3rem] overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.05)] hover:shadow-2xl transition-all group border border-brand-earth/50 flex flex-col h-full transform hover:-translate-y-2">
              ...
              <div className="p-10 flex flex-col flex-grow text-right">
                ...
                <button className="w-full bg-white text-brand-primary border-2 border-brand-primary hover:bg-brand-primary hover:text-white font-black py-4 rounded-2xl transition-all shadow-md active:scale-95">
                  طلب تسعيرة للمنتج
                </button>
              </div>
            </div>
